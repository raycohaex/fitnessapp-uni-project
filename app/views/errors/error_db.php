<?php
require APPROOT . '/views/inc/head.inc.php'; ?>
<div class="container">
    <div class="row align-items-center mt-5">
        <div class="col-6">
            <h1>Database error</h1>
            <p>Er is een fout opgetreden met het maken van een database verbinding.</p>
            <p>Probeer terug te gaan naar de <a class="text-danger" href="http://localhost/fitnessapp">home pagina</a> of contacteer ons.</p>
            <a href="#" class="btn btn-dark rounded-0">Contact opnemen</a>
        </div>
        <div class="col-6">
            <svg style="width:400px;height:400px;" id="aa03ddf9-f8f2-4819-a4ce-be9b0a220741" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                 width="1119.60911" height="699" viewBox="0 0 1119.60911 699"><title>server down</title>
                ...
                <path d="M140.09162,291.85056c0-78.36865,54.255-141.78356,121.30372-141.78356"
                      transform="translate(-31.39089 -100.5)" fill="#63ff80"/>
                ...
                <rect x="271.60911" y="150" width="16" height="16" fill="#63ff80" opacity="0.4"/>
                <rect x="294.60911" y="150" width="16" height="16" fill="#63ff80" opacity="0.8"/>
                <rect x="317.60911" y="150" width="16" height="16" fill="#63ff80"/>
                <rect x="271.60911" y="251" width="16" height="16" fill="#63ff80" opacity="0.4"/>
                <rect x="294.60911" y="251" width="16" height="16" fill="#63ff80" opacity="0.8"/>
                <rect x="317.60911" y="251" width="16" height="16" fill="#63ff80"/>
                <rect x="271.60911" y="352" width="16" height="16" fill="#63ff80" opacity="0.4"/>
                <rect x="294.60911" y="352" width="16" height="16" fill="#63ff80" opacity="0.8"/>
                <rect x="317.60911" y="352" width="16" height="16" fill="#63ff80"/>
